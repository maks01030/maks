...
CREATE TABLE `likes` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_posts` (`posts_id`,`users_id`) /*!80000 INVISIBLE */,
  UNIQUE KEY `users_media` (`media_id`,`users_id`) /*!80000 INVISIBLE */,
...
CREATE TABLE `media` (
  ...
  `file` varchar(45) DEFAULT NULL COMMENT '/folder/file.jpg\n',
  `blob` blob,
...
-- Dump completed on 2021-02-09 12:07:43
